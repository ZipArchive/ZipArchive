...
{
    // https://pkware.cachefly.net/webdocs/casestudies/APPNOTE.TXT
	// For more compatibility on extraction set as made on UNIX (3) instead of DARWIN (19)
	uint16_t made_on_unix = 3 << 8;
    //MZ_ZIP_FLAG_UTF8
    uint16_t flag_base = 1 << 11;
    return zipOpenNewFileInZip5(entry, name.fileSystemRepresentation, zipfi, NULL, 0, NULL, 0, NULL, Z_DEFLATED, level, 0, -MAX_WBITS, DEF_MEM_LEVEL, Z_DEFAULT_STRATEGY, password.UTF8String, aes, made_on_unix, flag_base, 1);
}
